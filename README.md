...
- `python backend/main.py --parse-descriptions` – backfill structured summaries for stored job descriptions.
- `python backend/main.py --ai-purge` – flag irrelevant postings via the configured `gpt-5-mini` model.
